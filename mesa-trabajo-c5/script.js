...
function nuevaNoticia(title,link,parrafo){
    const template = `
    <div class="item">
    <img src=${link}>
    <h2>${title}</h2>
...
const datos = [
    {
        title: "El tigre",
        link:"./imagenes/tiger.jpg",
        parrafo:`El tigre (Panthera tigris) es una de las especies​ de la subfamilia de los panterinos (familia Felidae)
    ...
    {
        title: "El leon",
        link:"./imagenes/leon.jpg",
        parrafo:`El león (Panthera leo) es un mamífero carnívoro de la familia de los félidos y una de las cinco especies del
    ...
    },
    {
        ...
        link:"./imagenes/pantera-negra.jpg",
        parrafo:`La pantera negra es una variación negra (melanismo) de varias especies de grandes félidos, en especial del
    ...
    {
        title: "El jaguar",
        link:"./imagenes/jaguar.jpg",
        parrafo:`El jaguar, yaguar o yaguareté (Panthera onca) es un carnívoro félido de la subfamilia de los Panterinos y
    ...
    {
        title: "El quepardo",
        link:"./imagenes/chita.jpg",
        parrafo:`El guepardo o chita (Acinonyx jubatus)1​ es un miembro atípico de la familia de los félidos. Es el único
...
datos.forEach(e => contenedor.innerHTML+=nuevaNoticia(e.title,e.link,e.parrafo));
